          ...
          {tab === "excel" ? (
            <div className="flex items-start gap-3 p-3 bg-info/5 border border-info/20 rounded-xl">
              ...
              <div className="text-xs text-text-secondary leading-relaxed">
                Upload file <strong>.xlsx</strong> sesuai format template
                (multi-sheet). Sheet1 = Data Utama, sheet lain = Keluarga,
                Rekening, Pendidikan, Sertifikasi, Diklat, Jabatan, dll. Jika
