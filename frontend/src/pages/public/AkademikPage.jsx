...
// ─── Inline Styles ─────────────────────────────────────────────────────────────
const styles = `
  .akademik-islamic-pattern {
    background-image: url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0l15 15-15 15L15 15zM0 30l15 15-15 15L-15 15zM60 30l15 15-15 15L45 15zM30 60l15 15-15 15L15 75z' fill='%23004d40' fill-opacity='0.03' fill-rule='evenodd'/%3E%3C/svg%3E");
  }
  .akademik-particle-container {
    position: absolute;
    inset: 0;
    overflow: hidden;
    pointer-events: none;
  ...
  .akademik-kurikulum-card:hover .akademik-particle-container {
    opacity: 1;
  }
  .akademik-particle {
    position: absolute;
    font-family: 'Material Symbols Outlined';
    animation: akademikFloat 6s infinite ease-in-out;
    opacity: 0;
  }
  ...
  .akademik-journey-card {
    transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275);
  }
  .akademik-journey-card:hover {
    transform: scale(1.05);
    box-shadow: 0 20px 40px -10px rgba(0, 52, 43, 0.15);
    border-color: rgba(0, 52, 43, 0.3);
  }
  .akademik-journey-circle {
    transition: all 0.4s ease;
  }
  .akademik-journey-group:hover .akademik-journey-circle {
    box-shadow: 0 0 25px 5px rgba(0, 110, 42, 0.4);
    transform: translateX(-50%) scale(1.15);
  }
`;

// ─── Warna Brand (sesuai project) ─────────────────────────────────────────────
// primary     = #00342b  (brand-darkgreen tua)
// secondary   = #006e2a  (brand-green gelap)
// brand-green = #00c853  (aksen hijau terang)
// background  = #f8f9fa

export default function AkademikPage() {
  const particleContainerRef = useRef(null);
  const kurikulumCardRef = useRef(null);
  const particleIntervalRef = useRef(null);

  useEffect(() => {
    const container = particleContainerRef.current;
    const card = kurikulumCardRef.current;
    ...
    function createParticle() {
      ...
      particle.classList.add("akademik-particle", "material-symbols-outlined");
    ...
    const handleLeave = () => clearInterval(particleIntervalRef.current);
  ...
  return (
    <div className="bg-[#f8f9fa] text-[#191c1d] font-sans antialiased min-h-screen overflow-x-hidden">
      <style>{styles}</style>
      ...
      <main className="pt-[80px]">
        ...
        >
          <div className="absolute inset-0 bg-[#00342b]/60 z-10" />
          <div
          ...
          />
          <div className="relative z-20 text-center px-6 max-w-4xl mx-auto bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 p-10 md:p-12 shadow-2xl">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white mb-6 hover:bg-white/20 transition-all cursor-default">
            ...
            <h1 className="text-4xl md:text-[64px] font-extrabold text-white leading-[1.1] tracking-tight mb-6">
            ...
            <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto leading-relaxed mb-10">
              Membangun landasan intelektual yang kokoh berlandaskan nilai-nilai
              Al-Qur'an dan sains modern untuk mencetak generasi Rabbani yang
              unggul.
            </p>
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <a
                href="#curriculum"
                className="px-10 py-4 rounded-full bg-[#006e2a] text-white font-bold hover:-translate-y-1 hover:shadow-xl hover:shadow-[#006e2a]/40 transition-all duration-300 flex items-center gap-2"
              >
                Jelajahi Kurikulum
              ...
              <a
                href="#programs"
                className="px-10 py-4 rounded-full bg-white/10 backdrop-blur-md border border-white/30 text-white font-bold hover:bg-white/20 transition-all duration-300"
              >
                Program Unggulan
              </a>
            </div>
          ...
          <div className="absolute bottom-0 left-0 w-full z-20">
            <svg
              className="w-full h-auto text-[#f8f9fa] fill-current"
        ...
        <section
          className="bg-[#f8f9fa] akademik-islamic-pattern py-20"
          style={{
            background:
              "radial-gradient(circle at center, rgba(0,77,64,0.05) 0%, transparent 70%)",
          }}
        >
          <div className="max-w-[1280px] mx-auto px-6 relative">
            ...
            <div className="absolute -bottom-20 -right-20 w-96 h-96 bg-[#00342b]/5 rounded-full blur-3xl" />
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5 space-y-6 relative z-10">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#006e2a]/10 text-[#006e2a] text-xs font-bold tracking-widest uppercase rounded-full border border-[#006e2a]/20 backdrop-blur-sm">
                  ...
                  <span>Metodologi Unggulan</span>
                </div>
                <h2 className="text-4xl md:text-6xl font-extrabold text-[#00342b] leading-[1.1] tracking-tight">
              ...
              <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6 relative">
                ...
                <div className="bg-white/40 backdrop-blur-xl border border-white/40 p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 group hover:-translate-y-2">
                  <div className="w-14 h-14 bg-[#00342b] text-white rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
                    <span className="material-symbols-outlined text-3xl">
                      auto_awesome
                    </span>
                  </div>
                  <h3 className="text-xl font-bold text-[#00342b] mb-3">
                    Pondasi Adab &amp; Akhlak
                  </h3>
                ...
                {/* Card 3 – Full width */}
                <div className="md:col-span-2 bg-[#00342b] text-white p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 group relative overflow-hidden">
        ...
        >
          <div className="max-w-[1280px] mx-auto px-6">
            ...
            <div className="text-center mb-16 space-y-4">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-[#00342b] tracking-tight">
              ...
              <div className="mt-6 flex items-center gap-4">
                <div className="h-px flex-1 bg-gradient-to-r from-[#006e2a]/60 to-transparent" />
                <span className="material-symbols-outlined text-[#3ce36a] opacity-60">
                  star
                </span>
                <div className="h-px flex-1 bg-gradient-to-l from-[#006e2a]/60 to-transparent" />
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
              {/* Kurikulum Nasional – Kiri */}
              <div
                ref={kurikulumCardRef}
                className="akademik-kurikulum-card md:col-span-6 lg:col-span-5 rounded-3xl bg-gradient-to-br from-[#00342b] via-[#00342b] to-[#004d40] p-10 relative overflow-hidden group shadow-xl hover:shadow-2xl transition-all duration-500 border border-white/10 akademik-islamic-pattern"
              >
                <div
                  ref={particleContainerRef}
                  className="akademik-particle-container"
                />
                <div className="absolute inset-0 akademik-islamic-pattern opacity-20 group-hover:scale-110 transition-transform duration-700" />
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <div className="mb-12">
                    ...
                    <h3 className="text-4xl md:text-5xl font-extrabold text-white leading-tight mb-6 tracking-tight drop-shadow-md">
                      Kurikulum <br />
                      <span className="text-[#3ce36a]">Nasional</span>
                    </h3>
                    <p className="text-[#94d3c1]/90 text-lg leading-relaxed font-medium max-w-sm">
                      Mengadopsi standar kompetensi nasional yang diperkaya
                      dengan metode pembelajaran aktif dan berbasis proyek.
                    </p>
                    <div className="mt-6 flex items-center gap-4">
                      <div className="h-px flex-1 bg-gradient-to-r from-[#006e2a]/60 to-transparent" />
                      <span className="material-symbols-outlined text-[#3ce36a] opacity-60">
                  ...
                  <div className="flex flex-col gap-3 mt-auto">
                    {[
                      ...
                      >
                        <span className="material-symbols-outlined text-[#3ce36a]">
                          {item.icon}
                        </span>
              ...
              <div className="md:col-span-6 lg:col-span-7 grid grid-cols-1 gap-6">
                {/* Dirasah Islamiyah */}
                <div className="bg-white/40 backdrop-blur-xl border border-white/60 p-8 rounded-3xl shadow-sm hover:shadow-xl hover:border-[#006e2a]/40 hover:-translate-y-1 transition-all duration-500 group akademik-islamic-pattern">
                  <div className="flex items-start gap-6">
                    <div className="w-16 h-16 bg-[#00342b]/5 rounded-2xl flex items-center justify-center text-[#00342b] group-hover:bg-[#00342b] group-hover:text-white group-hover:rotate-6 transition-all duration-500 shrink-0 shadow-inner">
                      <span className="material-symbols-outlined text-4xl">
                        mosque
                      </span>
                    </div>
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold text-[#00342b] mb-3 drop-shadow-md">
                        Dirasah Islamiyah
                      </h3>
                      <p className="text-[#3f4945]/90 text-base leading-relaxed mb-6">
                ...
                <div className="bg-white/40 backdrop-blur-xl border border-white/60 p-8 rounded-3xl shadow-sm hover:shadow-xl hover:border-[#3f2900]/40 hover:-translate-y-1 transition-all duration-500 group">
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold text-[#00342b] mb-4 drop-shadow-md">
                        Ekstrakurikuler
                      </h3>
                      <div className="flex flex-wrap gap-3">
                        {["Pramuka", "Memanah", "Koding"].map((ekskul) => (
                          <span
                            key={ekskul}
        ...
        <section
          className="py-20 bg-[#f8f9fa] relative overflow-hidden akademik-islamic-pattern"
          style={{
            background:
              "radial-gradient(circle at center, rgba(0,77,64,0.05) 0%, transparent 70%)",
          }}
          ...
          <div className="max-w-[1280px] mx-auto px-6 relative z-10">
            ...
            <div className="text-center mb-20">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#006e2a]/10 text-[#006e2a] text-xs font-bold tracking-widest uppercase rounded-full border border-[#006e2a]/20 mb-6">
                ...
                <span>Roadmap Pendidikan</span>
              </div>
              <h2 className="text-4xl md:text-6xl font-extrabold text-[#00342b] tracking-tight mb-6">
            ...
            <div className="relative">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-1.5 bg-gradient-to-b from-[#00342b]/5 via-[#006e2a]/40 to-[#00342b]/5 hidden md:block rounded-full shadow-inner" />

              <div className="space-y-24 relative">
                {/* Step 1: Foundational */}
                <div className="relative flex flex-col md:flex-row items-center justify-between group akademik-journey-group">
                  <div className="md:w-5/12 text-right pr-16 hidden md:block">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#00342b]/5 text-[#00342b] mb-4 group-hover:scale-110 transition-transform duration-500">
                      <span className="material-symbols-outlined text-4xl">
                        child_care
                      </span>
                    </div>
                    <h4 className="text-3xl font-extrabold text-[#00342b]">
                      Foundational Stage
                    </h4>
                  ...
                  <div className="absolute left-1/2 akademik-journey-circle w-20 h-20 rounded-full bg-[#00342b] text-white flex items-center justify-center font-bold text-2xl z-20 shadow-2xl border-8 border-[#f8f9fa]">
                    <div className="absolute inset-0 rounded-full animate-pulse bg-[#00342b]/20" />
                    <span className="relative z-10">1-2</span>
                  </div>
                  <div className="md:w-5/12 pl-16 w-full">
                    <div className="bg-white/40 backdrop-blur-xl p-10 rounded-[2.5rem] shadow-xl border border-white/60 akademik-journey-card">
                      <div className="md:hidden mb-6 flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-[#00342b]/10 flex items-center justify-center text-[#00342b]">
                          <span className="material-symbols-outlined">
                            child_care
                          </span>
                        </div>
                        <h4 className="text-2xl font-bold text-[#00342b]">
                          Foundational Stage
                        </h4>
                      </div>
                      <ul className="space-y-5">
                        {[
                          ...
                          >
                            ...
                            <div>
                              <span className="font-bold text-[#00342b] block">
                                {item.title}
                              </span>
                ...
                {/* Step 2: Development */}
                <div className="relative flex flex-col md:flex-row-reverse items-center justify-between group akademik-journey-group">
                  <div className="md:w-5/12 text-left pl-16 hidden md:block">
                    ...
                    <h4 className="text-3xl font-extrabold text-[#006e2a]">
                      Development Stage
                    </h4>
                    <p className="text-[#3f4945] text-lg mt-3 leading-relaxed">
                  ...
                  <div className="absolute left-1/2 akademik-journey-circle w-20 h-20 rounded-full bg-[#3f2900] text-white flex items-center justify-center font-bold text-2xl z-20 shadow-2xl border-8 border-[#f8f9fa]">
                    <div className="absolute inset-0 rounded-full animate-pulse bg-[#3f2900]/20" />
                    <span className="relative z-10">3-4</span>
                  </div>
                  <div className="md:w-5/12 pr-16 w-full">
                    <div className="bg-white/40 backdrop-blur-xl p-10 rounded-[2.5rem] shadow-xl border border-white/60 akademik-journey-card">
                      <div className="md:hidden mb-6 flex items-center gap-4">
                        ...
                        <h4 className="text-2xl font-bold text-[#006e2a]">
                          Development Stage
                        </h4>
                      </div>
                      <ul className="space-y-5">
        ...
        {/* ── 5. How Students Learn (Storytelling) ──────────────────────── */}
        <section
        ...
        >
          <div className="max-w-[1280px] mx-auto px-6 relative">
            <div className="absolute -top-20 -right-20 w-96 h-96 bg-[#00342b]/5 rounded-full blur-3xl opacity-60" />
            <div className="absolute -bottom-20 -left-20 w-96 h-96 bg-[#006e2a]/5 rounded-full blur-3xl opacity-60" />
            <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24 relative z-10">
              {/* Image */}
              <div className="lg:w-1/2 relative group">
                <div className="absolute -inset-6 bg-[#00342b]/5 rounded-[2.5rem] transform -rotate-3 transition-transform group-hover:rotate-0 duration-700" />
                ...
                <div className="relative z-10 rounded-[2rem] overflow-hidden shadow-2xl aspect-[4/5] md:aspect-square">
                  <img
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-[#00342b]/40 to-transparent opacity-60" />
                </div>
                {/* Floating card */}
                <div className="absolute -bottom-10 -right-6 md:-right-12 bg-white/90 backdrop-blur-xl p-6 rounded-2xl shadow-2xl border border-white/50 z-20 max-w-xs transform transition-all duration-500 hover:-translate-y-2">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    <div className="font-extrabold text-[#00342b] text-xl">
                      Active Learning
                    </div>
                  </div>
              ...
              <div className="lg:w-1/2 space-y-10">
                <div className="space-y-4">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#00342b]/5 text-[#00342b] text-xs font-bold tracking-widest uppercase rounded-full border border-[#00342b]/10">
                    <span className="material-symbols-outlined text-sm">
                      auto_awesome
                    </span>
                    <span>Ekosistem Belajar</span>
                  </div>
                  <h2 className="text-4xl md:text-5xl font-extrabold text-[#00342b] leading-tight">
                ...
                <div className="grid gap-6">
                  {[
                    ...
                    <div
                      key={card.title}
                      className="group bg-white/60 backdrop-blur-md p-6 rounded-2xl border border-white/80 shadow-sm hover:shadow-xl hover:border-[#006e2a]/30 transition-all duration-300 flex gap-6 items-start"
                    >
                      <div
                        className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 ${card.iconBg} group-hover:text-white transition-colors duration-500`}
                      >
                        <span className="material-symbols-outlined text-3xl">
                          {card.icon}
                        </span>
                      ...
                      <div>
                        <h4 className="font-bold text-[#00342b] text-xl mb-2">
                          {card.title}
                        </h4>
                        <p className="text-sm text-[#3f4945] leading-relaxed">
                          {card.desc}
        ...
        {/* ── 6. Teachers ───────────────────────────────────────────────── */}
        <section
          className="py-20 bg-[#f3f4f5] relative overflow-hidden akademik-islamic-pattern"
          style={{
            background:
        ...
        >
          <div className="max-w-[1280px] mx-auto px-6">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#00342b]/5 text-[#00342b] text-xs font-bold tracking-widest uppercase rounded-full border border-[#00342b]/10 mb-6">
                <span className="material-symbols-outlined text-sm">
                  groups
                </span>
                <span>Tim Akademik</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-extrabold text-[#00342b] tracking-tight mb-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={teacher.name}
                  className={`group relative bg-white/60 backdrop-blur-xl rounded-[2rem] p-8 border border-white/80 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 text-center overflow-hidden ${teacher.mt}`}
                >
                  ...
                  <div className="relative mb-6 inline-block">
                    <div className="w-28 h-28 mx-auto bg-[#00342b]/5 rounded-full flex items-center justify-center border-2 border-dashed border-[#00342b]/20 group-hover:border-[#006e2a]/40 transition-colors">
                      <span className="material-symbols-outlined text-5xl text-[#00342b]/40 group-hover:text-[#006e2a] transition-colors">
                        person
                      </span>
                    </div>
                  ...
                  <h4 className="font-bold text-[#00342b] text-lg mb-1">
                    {teacher.name}
                  </h4>
        ...
        <section className="py-24 relative overflow-hidden bg-white">
          <div className="absolute inset-0 akademik-islamic-pattern opacity-5" />
          <div className="max-w-5xl mx-auto px-6 relative z-10">
            <div className="bg-gradient-to-br from-[#00342b] via-[#00342b] to-[#004d40] rounded-[2.5rem] p-12 md:p-20 shadow-2xl border border-white/10 relative overflow-hidden group hover:scale-[1.01] hover:shadow-[#006e2a]/40 transition-all duration-500">
              <div className="absolute inset-0 opacity-20 mix-blend-overlay pointer-events-none akademik-islamic-pattern" />
              ...
              <div className="relative z-10 text-center space-y-8">
                <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 backdrop-blur-md border border-white/20 rounded-full text-[#3ce36a] text-xs font-bold tracking-[0.2em] uppercase mb-4">
                  <span className="material-symbols-outlined text-sm">
                    auto_awesome
                  </span>
                ...
                <h2 className="text-4xl md:text-6xl font-extrabold text-white leading-tight tracking-tight">
                  ...
                  <span className="text-[#3ce36a]">Generasi Rabbani?</span>
                </h2>
                ...
                <div className="flex flex-col sm:flex-row justify-center items-center gap-6 pt-6">
                  <Link
                    to="/ppdb"
                    className="group/btn px-10 py-4 bg-[#006e2a] text-white rounded-xl font-bold text-lg transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_0_30px_rgba(0,110,42,0.4)] hover:bg-[#00c853] hover:ring-4 hover:ring-[#006e2a]/20 flex items-center gap-3"
                  >
                  ...
                  <a
                    href="#"
                    className="px-10 py-4 bg-white/5 backdrop-blur-md border-2 border-white/20 text-white rounded-xl font-bold text-lg hover:bg-white/20 hover:border-white/40 hover:-translate-y-2 hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center gap-3"
                  >
                ...
                <div className="pt-12 flex items-center justify-center gap-8 opacity-60">
                  <div className="flex flex-col items-center hover:-translate-y-1 transition-transform duration-300 cursor-default group/stat">
                    <span className="text-white font-bold text-2xl group-hover/stat:text-[#3ce36a] transition-colors">
                      2024
                    </span>
      ...
      <a
        ...
        href="https://wa.me/6285811723878?text=Halo%20MI%20Nurul%20Huda%203,%20saya%20ingin%20bertanya%20mengenai%20Program%20Akademik"
        target="_blank"
        rel="noreferrer"
        aria-label="WhatsApp"
      >
