      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="card text-center p-8">
            ...
            <p className="text-indigo-600 font-medium mt-1">NISN: {siswa.nisn}</p>
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="card shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <InfoItem label="Kewarganegaraan" value={siswa.kewarganegaraan || "-"} />
              <InfoItem label="Anak ke-" value={siswa.anak_ke || "-"} />
              <InfoItem label="Status dalam Keluarga" value={siswa.status_dalam_keluarga || "-"} />
              <InfoItem label="No. Akta Lahir" value={siswa.no_akta_lahir || "-"} />
          ...
          <div className="card shadow-sm border border-gray-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="col-span-1 sm:col-span-2">
                <InfoItem label="Jalan/Dusun" value={siswa.alamat_jalan || "-"} />
              </div>
              <InfoItem
                label="RT / RW"
          ...
          <div className="card shadow-sm border border-gray-100">
            <h3 className="font-semibold text-gray-800 mb-4 flex items-center gap-2 border-b border-gray-100 pb-3">
              <Calendar className="w-5 h-5 text-orange-500" /> Data Akademik Awal
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <InfoItem label="Asal Sekolah" value={siswa.asal_sekolah || "-"} />
              <InfoItem 
                label="Tanggal Masuk" 
                value={siswa.tanggal_masuk ? dayjs(siswa.tanggal_masuk).format("DD MMMM YYYY") : "-"} 
              />
            </div>
          </div>
